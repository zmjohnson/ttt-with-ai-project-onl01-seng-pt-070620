...
describe 'Game' do
  ...
  describe 'play' do
    ...
    it 'congratulates the winner X' do
      ...
      expect($stdout).to receive(:puts).with("Congratulations X, you have won!")
    ...
    it 'congratulates the winner O' do
      ...
      expect($stdout).to receive(:puts).with("Congratulations O, you have won!")
    ...
    it 'prints "Cat\'s Game!" on a draw' do
      ...
      expect($stdout).to receive(:puts).with("Darn, Cat's Game!")
